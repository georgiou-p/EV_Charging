...
# Optional: check unique values to confirm field names
# print(gdf["LAD25CD"].unique())
# print(gdf["CTRY25NM"].unique())  # This may vary based on your dataset

# === Step 1: Remove entire Northern Ireland ===
# If country name field exists (often "CTRY25NM" or "country"), filter directly:
if "CTRY25NM" in gdf.columns:
    gdf = gdf[~gdf["CTRY25NM"].str.contains("Northern Ireland", case=False)]
else:
    # Or exclude based on LAD codes starting with N (e.g., "N09...")
